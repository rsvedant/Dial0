  ...
  const cards = [
    {
      ...
      description:
        "Upload receipts, call recordings, and intents. DialZero builds a call brief from issues already in Convex.",
    },
    {
      title: "Research before we dial",
      description:
        "Inkeep RAG, Firecrawl research, and GPT-OSS-120b assemble policy citations, escalation paths, and scripts before the call starts.",
    },
    {
      title: "Live oversight & history",
      description:
        "Stream transcripts, retries, and approvals into dashboards and notifications so the whole team stays aligned without joining the line.",
    },
  ]
  ...
  return (
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-6 shadow-[0px_0px_0px_0.75px_#E0DEDB] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4">
          <Badge
            icon={
              <div className="w-[10.5px] h-[10.5px] outline outline-[1.17px] outline-[#37322F] outline-offset-[-0.58px] rounded-full" />
            }
            text="DialZero platform"
          />
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
            Everything you need to hand off the call
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            DialZero unifies intake, research, live calling, and follow-up so founders and operators stay focused on building—not battling hold music.
          </div>
        </div>
      </div>
