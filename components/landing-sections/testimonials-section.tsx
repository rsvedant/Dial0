...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "DialZero spun up a voice clone, called the insurer, and escalated twice while we kept building. The transcript and commitments synced into Convex automatically.",
      name: "Jamie Marshall",
      company: "Co-founder, RelayGrid",
      image:
    ...
    {
      quote:
        "Our ops team drops disputes into DialZero and walks away. The agent cites policy from Inkeep research, loops us in when decisions land, and bills minutes back to Autumn.",
      name: "Sarah Chen",
      company: "Head of Operations, Foundry",
      image:
    ...
    {
      quote:
        "Finance finally trusts AI escalations. DialZero records every call, syncs notes to the dashboard, and hands accounting a clean trail for reimbursements.",
      name: "Marcus Rodriguez",
      company: "Finance Director, Atlas Labs",
      image:
  ...
  return (
    <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
      <div className="self-stretch px-4 sm:px-6 md:px-24 py-10 sm:py-14 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center">
        <div className="w-full max-w-[620px] px-6 py-5 shadow-[0px_0px_0px_0.75px_#E0DEDB] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4">
          <Badge
            icon={
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 5.5L6 2L10 5.5V10H2V5.5Z" stroke="#37322F" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            }
            text="Customer stories"
          />
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight md:leading-[56px] font-sans tracking-tight">
            Teams trust DialZero to finish the call
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base sm:text-lg font-normal leading-7 font-sans">
            Founders, operators, and finance leads stay focused on shipping while DialZero handles the escalations, receipts, and reporting.
          </div>
        </div>
      </div>

      {/* Testimonial Content */}
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border-b">
