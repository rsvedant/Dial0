      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">DialZero</div>
          </div>
          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans">
            AI advocates that finish the call for you
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2 text-sm leading-5 font-sans">
              <Link href="#how-it-works" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                How it works
              </Link>
              <Link href="#pricing" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                Pricing
              </Link>
              <Link href="#stack" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                Stack
              </Link>
              <Link href="#faq" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                FAQ
              </Link>
              <a href="https://github.com/rsvedant/Dial0" className="text-[#49423D] hover:text-[#37322F] transition-colors" target="_blank" rel="noreferrer">
                Architecture
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-start gap-2 text-sm leading-5 font-sans">
              <a href="https://docs.dial0.ai" className="text-[#49423D] hover:text-[#37322F] transition-colors" target="_blank" rel="noreferrer">
                Documentation
              </a>
              <a href="https://blog.dial0.ai" className="text-[#49423D] hover:text-[#37322F] transition-colors" target="_blank" rel="noreferrer">
                Blog
              </a>
              <a href="https://status.dial0.ai" className="text-[#49423D] hover:text-[#37322F] transition-colors" target="_blank" rel="noreferrer">
                Status
              </a>
              <a href="/legal/privacy" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                Privacy
              </a>
              <a href="/legal/terms" className="text-[#49423D] hover:text-[#37322F] transition-colors">
                Terms
              </a>
            </div>
          </div>
