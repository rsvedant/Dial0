...
export const metadata: Metadata = {
  title: "DialZero - Your AI Agent Against Frustrating Customer Service",
  description:
    "Skip the waiting, beat the bots. DialZero uses AI to understand your issues and automatically contact the right people to get things done.",
}
